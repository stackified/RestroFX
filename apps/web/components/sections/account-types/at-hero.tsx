...
export function AccountTypesHero() {
    return (
        <section className="relative pt-32 pb-20 overflow-hidden min-h-[60vh] flex items-center justify-center">
            {/* Dynamic Background Elements matching hero-section-enhanced */}
            ...
            <div className="container relative mx-auto px-4 text-center z-10">
                ...
                >
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-600/10 border border-red-600/20 text-red-600 text-sm font-bold mb-8 backdrop-blur-md"
                    >
