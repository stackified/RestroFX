...
export default function RegisterPage() {
    useEffect(() => {
        window.location.replace("https://portal.restrofx.com/register");
    }, []);
    ...
    return (
        <div className="min-h-screen relative w-full bg-white flex flex-col font-sans selection:bg-red-500/20">
            ...
            <div className="flex-1 flex flex-col items-center justify-center relative w-full overflow-hidden">
                ...
                {/* Content Layer */}
                <div className="relative z-10 w-full max-w-md p-4 sm:p-6 my-12 sm:my-20 text-center">
                    <div className="bg-white rounded-3xl shadow-[0_8px_40px_-12px_rgba(0,0,0,0.1)] border border-neutral-100 p-8 sm:p-10">
                        ...
                        <p className="text-neutral-500 mb-8">Please wait while we take you to the RestroFX registration page...</p>
                        
                        <Button 
                            className="w-full h-12 font-bold"
                            onClick={() => window.location.replace("https://portal.restrofx.com/register")}
                        >
                        ...
                        <div className="mt-8 pt-6 border-t border-neutral-100 text-sm text-neutral-500">
                            ...
                            <Link href="https://portal.restrofx.com/login" className="text-red-600 hover:text-red-700 font-bold hover:underline underline-offset-4 transition-all ml-1">
                                Sign In
                            </Link>
                        </div>
                    </div>
